...
selected_wavelength_indices = uve_wavelength_selection(X_train_centered.values, Y_train, n_components=PARAMS['MCS_N_COMPONENTS'])
...
base_filename = 'PLS_Protein_Standardize_Centering_UVE'
counter = 1
