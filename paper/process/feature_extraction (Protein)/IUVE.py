...
PARAMS = {
    ...
    'WAVELENGTH_RANGE_STR': '600-1099.5',  # 修正為與 WAVELENGTH_RANGE 一致
    ...
    'UVE_NOISE_VARIABLES': 100,  # UVE 隨機噪聲變量數量
...
selected_wavelength_indices = iuve_wavelength_selection(X_train_centered.values, Y_train, n_components=PARAMS['MCS_N_COMPONENTS'])
...
print(f"  IUVE 波長選擇後，訓練集形狀: {X_train_selected.shape}, 測試集形狀: {X_test_selected.shape}")
...
base_filename = 'PLS_Protein_Standardize_Centering_IUVE'
counter = 1
