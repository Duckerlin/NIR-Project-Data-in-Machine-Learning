...
PARAMS = {
    ...
    'UVE_NOISE_VARIABLES': 1000,  # UVE 隨機噪聲變量數量
...
# 使用 UVE 選擇重要波長
selected_wavelength_indices = uve_wavelength_selection(X_train, Y_train, n_components=PARAMS['MCS_N_COMPONENTS'])
...
plt.title('PLS Regression: Actual vs Predicted Ash (UVE)')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
output_filename = f'PLS_Ash_UVE_Centering_{timestamp}.xlsx'
