...
print(f"  使用預處理後數據，訓練集形狀: {X_train_selected.shape}, 測試集形狀: {X_test_selected.shape}")
print(f"  使用波長數量: {X_train_selected.shape[1]}")
...
common_params = {
    ...
    'Number of Wavelengths Used': X_train_selected.shape[1],
...
base_filename = 'PLS_Fat_MAS_Centering_NoCARS'
counter = 1
