...
PARAMS = {
    ...
    'TRAIN_TEST_RATIO_STR': '80:20',  # 訓練-測試比例字串表示（修正與實際比例一致）
...
selected_wavelengths = cars(X_train_preprocessed, Y_train)
X_train_selected = X_train_preprocessed[:, selected_wavelengths]
X_test_selected = X_test_preprocessed[:, selected_wavelengths]
...
plt.title('CARS Selected Wavelengths for Moisture')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.show()
...
base_filename = 'PLS_Moisture_SGS_Autoscaling_CARS'
counter = 1
