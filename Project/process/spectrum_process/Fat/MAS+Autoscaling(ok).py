...
print(" NIR 光譜 MAS 預處理（在標準化後）完成")

# === 步驟 6: 使用標準化及MAS數據 ===
X_train_selected = X_train
X_test_selected = X_test
print(f" 使用標準化及 MAS 數據，訓練集形狀: {X_train_selected.shape}, 測試集形狀: {X_test_selected.shape}")
...
base_filename = 'PLS_Fat_Autoscaling_MAS_NoCARS'
counter = 1
