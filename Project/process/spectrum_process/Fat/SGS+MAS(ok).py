...
PARAMS = {
    ...
    'WAVELENGTH_RANGE_STR': '750-1200',  # 波長範圍字串表示
...
if len(nir_final_df) != 900:
    print(f" 波長點數 {len(nir_final_df)} 不等於預期 900，檢查數據格式")
...
base_filename = 'PLS_Fat_Standardize_SGS_MAS_NoCARS'
counter = 1
